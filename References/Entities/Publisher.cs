...
namespace Xrm.PluginDeployer.Entities
{
    ...
    public partial class Publisher : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// IsReadonly as Enum
        /// </summary>
        public System.Nullable<Xrm.PluginDeployer.Entities.Publisher.OptionSet.IsReadOnlyPublisher> IsReadonlyAsEnum
        {
            get
            {
                if (!IsReadonly.HasValue) return null;
                if (IsReadonly.Value) return Xrm.PluginDeployer.Entities.Publisher.OptionSet.IsReadOnlyPublisher.Yes;
                return Xrm.PluginDeployer.Entities.Publisher.OptionSet.IsReadOnlyPublisher.No;
            }
            set
            {
                if (!value.HasValue) this.SetAttributeValue("isreadonly", null);
                if (value.Value == Xrm.PluginDeployer.Entities.Publisher.OptionSet.IsReadOnlyPublisher.Yes)
                {
    ...
    public partial class CrmContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
    {
        ...
        /// <summary>
        /// Gets a binding to the set of all <see cref="Xrm.PluginDeployer.Entities.Publisher"/> entities.
        /// </summary>
        public System.Linq.IQueryable<Xrm.PluginDeployer.Entities.Publisher> PublisherSet
        {
            get
            {
                return this.CreateQuery<Xrm.PluginDeployer.Entities.Publisher>();
            }
        }
    }
}
