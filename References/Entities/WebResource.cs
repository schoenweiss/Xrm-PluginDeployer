...
namespace Xrm.PluginDeployer.Entities
{
    ...
    public partial class WebResource : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// </summary>
        public System.Nullable<Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsAvailableForMobileOffline> IsAvailableForMobileOfflineAsEnum
        {
            get
            {
                if (!IsAvailableForMobileOffline.HasValue) return null;
                if (IsAvailableForMobileOffline.Value) return Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsAvailableForMobileOffline.Yes;
                return Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsAvailableForMobileOffline.No;
            }
            set
            {
                if (!value.HasValue) this.SetAttributeValue("isavailableformobileoffline", null);
                if (value.Value == Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsAvailableForMobileOffline.Yes)
                {
        ...
        /// </summary>
        public System.Nullable<Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsEnabledForMobileClient> IsEnabledForMobileClientAsEnum
        {
            get
            {
                if (!IsEnabledForMobileClient.HasValue) return null;
                if (IsEnabledForMobileClient.Value) return Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsEnabledForMobileClient.Yes;
                return Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsEnabledForMobileClient.No;
            }
            set
            {
                if (!value.HasValue) this.SetAttributeValue("isenabledformobileclient", null);
                if (value.Value == Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsEnabledForMobileClient.Yes)
                {
        ...
        /// IsManaged as Enum
        /// </summary>
        public System.Nullable<Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsComponentManaged> IsManagedAsEnum
        {
            get
            {
                if (!IsManaged.HasValue) return null;
                if (IsManaged.Value) return Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsComponentManaged.Managed;
                return Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsComponentManaged.Unmanaged;
            }
            set
            {
                if (!value.HasValue) this.SetAttributeValue("ismanaged", null);
                if (value.Value == Xrm.PluginDeployer.Entities.WebResource.OptionSet.IsComponentManaged.Managed)
                {
